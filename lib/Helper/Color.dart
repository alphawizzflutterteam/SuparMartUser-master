...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xffeb7327);
  static const Color secondary = Color(0xff2d3b4e);
  ...
  static const Color grad1Color = Color(0xffeb7327);
  static const Color grad2Color = Color(0xff2d3b4e);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xFFF88112);
